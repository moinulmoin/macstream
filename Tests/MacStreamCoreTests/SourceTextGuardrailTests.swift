...
func studioKeepsFrequentControlsInBottomDeck() throws {
    ...
    #expect(capturePreflightSource.contains("permissionRows(rows, suppressingActionsFor:"))
    ...
    #expect(destinationSource.contains("@Environment(\\.openSettings)"))
    #expect(destinationSource.contains("openSettings()"))

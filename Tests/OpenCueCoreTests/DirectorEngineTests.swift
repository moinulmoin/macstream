...
func studioKeepsFrequentControlsInBottomDeck() throws {
    ...
    #expect(studioSource.contains(".frame(width: 38)"))
    ...
    #expect(studioSource.contains("InspectorHeaderView(isSetupFocused: store.shouldShowSetupChecklist)"))
    #expect(studioSource.contains("isSetupFocused: store.shouldShowSetupChecklist"))
    ...
    #expect(studioSource.contains("if store.shouldShowSetupChecklist { return \"checklist\" }"))
    ...
    #expect(controlSource.contains(".minimumScaleFactor(0.76)"))

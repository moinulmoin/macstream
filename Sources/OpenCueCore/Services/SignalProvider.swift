...
public final class SystemSignalProvider: SignalProvider, @unchecked Sendable {
    ...
    private let stateQueue = DispatchQueue(label: "com.ideaplexa.opencue.signal-provider")
...
private final class ScreenMotionMonitor: NSObject, SCStreamOutput, @unchecked Sendable {
    ...
    private let queue = DispatchQueue(label: "com.opencue.signal.screen-motion", qos: .utility)
    private let lock = NSLock()
